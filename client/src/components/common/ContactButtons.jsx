    ...
    return (
        <>
            ...
            <div className="hidden md:block fixed bottom-8 right-8 z-50">
                <div className="bg-white rounded-2xl shadow-2xl p-4 border-2 border-primary/20">
                    <div className="text-center mb-3">
                        <p className="font-bold text-gray-800 text-sm">Liên hệ ngay</p>
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <a
                            ...
                            className="flex items-center gap-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white px-5 py-3 rounded-xl font-semibold transition-all hover:shadow-lg hover:scale-105 hover:from-blue-600 hover:to-blue-700"
                        >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white px-5 py-3 rounded-xl font-semibold transition-all hover:shadow-lg hover:scale-105 hover:from-blue-700 hover:to-blue-800"
                        >
